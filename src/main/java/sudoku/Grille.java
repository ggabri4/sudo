...
/**
 * Interface de grille de sudoku. Chaque case d'une
 * Grille peut contenir un ElementDeGrille ou null si
 * aucun élément n'est placé.
 * Une Grille doit toujours respecter les règles du sudoku.
 * <p>
 * Une Grille peut contenir des cases qui ne doivent
 * pas être modifiées (les valeurs initiales de la Grille)
 *
...
public interface Grille {
     ...
     * @throws ValeurImpossibleException        si l'élément de grille
     *                                          n'est pas autorisé
     *                                          à cette position dans la grille
     *                                          aux vues des autres valeurs
     *                                          de la grille
     * @throws ElementInterditException         si l'élément de grille n'est
     *                                          pas autorisé dans cette grille
     ...
     * position x,y en respectant les règles du sudoku et sans
     * modifier une valeur initiale.
